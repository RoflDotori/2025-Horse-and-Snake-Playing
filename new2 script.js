    ...
    try {
        window.Kakao.Share.sendDefault({
            ...
            content: {
                ...
                description: resultContent || '나의 2025년은 어떤 모습일까?',
                imageUrl: 'https://dotori-forest-make-2025puns.netlify.app/images/snake-wave.png', // 절대 경로 사용
                link: {
                    webUrl: 'https://dotori-forest-make-2025puns.netlify.app',
                    mobileWebUrl: 'https://dotori-forest-make-2025puns.netlify.app'
                }
            },
            buttons: [
                {
